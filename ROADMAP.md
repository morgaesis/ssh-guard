...
- Multi-model benchmark with Pareto analysis across six candidates (Gemini 3 Flash, GPT 5.4 Nano, Llama 4 Maverick, DeepSeek V3.2, Qwen3 32B, MiniMax M2.7) selecting `openai/gpt-5.4-nano -> meta-llama/llama-4-maverick` as the recommended chain; see `.cache/analysis.md`.
