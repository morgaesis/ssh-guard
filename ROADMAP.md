...
- Windows launcher bootstrap: `deployment/windows/guard-launch.ps1` runs guard natively over loopback TCP and can copy a missing Windows kubeconfig from Ubuntu WSL before daemon startup.
